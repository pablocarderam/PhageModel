...
setup = function(pParam) {
  with(as.list(pParam),{ # replace parameters into starting conditions
    ...
    S0 = N0                 # Starting susceptible bacteria ( CFU/mL )
    R10 = 0                 # Starting bacteria resistant to phage 1 ( CFU/mL )
    R20 = 0                 # Starting bacteria resistant to phage 1 ( CFU/mL )
    R120 = 0                # Starting bacteria resistant to phages 1 and 2 ( CFU/mL )
